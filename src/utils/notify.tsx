// From https://github.com/erhant/nextjs-web3-starter/blob/main/frontend/utils/notify.tsx
 ...
 * @returns {string} notification ID
 */
export const genericErrorNotify = (
  error: any,
  title: string = "Error",
  log: boolean = true
): string => {
...
export const updateTransactionNotify = (
  id: string,
  message?: ReactNode,
  variant?: VariantType
) => {
